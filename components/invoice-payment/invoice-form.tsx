...
export function InvoiceForm({ branches, customers, deliveries }: InvoiceFormProps) {
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <form action={createInvoice} className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <input name="invoice_number" placeholder="Invoice number" className="rounded-xl border border-slate-200 px-3 py-2" required />
        <input name="invoice_date" type="date" className="rounded-xl border border-slate-200 px-3 py-2" required />
        <input name="due_date" type="date" className="rounded-xl border border-slate-200 px-3 py-2" />
        ...
        <select name="delivery_record_id" className="rounded-xl border border-slate-200 px-3 py-2">
        ...
        <input name="invoice_value" type="number" min="0.01" step="0.01" placeholder="Invoice value" className="rounded-xl border border-slate-200 px-3 py-2" required />

        <select name="payment_status" className="rounded-xl border border-slate-200 px-3 py-2" defaultValue="sudah_ditagih">
        ...
        <input name="notes" placeholder="Notes" className="rounded-xl border border-slate-200 px-3 py-2 xl:col-span-3" />
        <button type="submit" className="rounded-xl bg-slate-950 px-4 py-2 text-sm font-semibold text-white">Save Invoice</button>
      </form>
    </section>
  );
}
